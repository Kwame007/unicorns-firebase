          ...
          <form onSubmit={addUniversity}>
            ...
            <div>
              <div className=" mb-5">
                <div className="">
                  <select
                    className="w-full text-base font-semibold text-slate-700  border-2  h-12 rounded-lg focus:outline-none focus:border-indigo-500 "
              ...
              <div>
                ...
                <div class="relative pb-0.5">
                  <div class="flex items-center justify-center w-full">
                    <label
                      class="w-full rounded-lg mt-5 border-2 border-slate-300 hover:text-primary cursor-pointer text-center py-12"
                      for="upload"
                    >
                      <svg
              ...
              <button className="flex items-center gap-3 px-10 mt-3 rounded-lg text-white bg-indigo-400 h-12 transition-all duration-500 hover:bg-indigo-500">
                Submit
              </button>
            </div>
          </form>
