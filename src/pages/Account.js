  ...
  return (
    <>
      ...
      <Modal isShowing={isShowing}>
        <div
          class={`fixed top-60 ${
            isDelete.current && "left-80"
          } z-50 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 ${
            isDelete.current ? "sm:max-w-4xl" : "sm:max-w-lg"
          } sm:w-full`}
        >
          <div className="p-4 bg-white">
            <h3 class=" text-center sm:text-left text-xl sm:text-2xl leading-6 font-medium ">
              {!isDelete.current
